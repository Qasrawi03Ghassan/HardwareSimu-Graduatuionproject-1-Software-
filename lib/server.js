...
const courses=[
    {
      ...
      "author": "Mark Budnik",
      "image": "https://static.vecteezy.com/system/resources/previews/004/937/500/non_2x/abstract-circuit-board-background-vector.jpg",
      "usersEmails": "test@example.com,teab@2978@gmail.com",
      "level": "Beginner"
    },
    {
      "id": 2,
      ...
      "author": "Mark Budnik",
      "image": "https://static.vecteezy.com/system/resources/previews/026/183/030/non_2x/abstract-modern-technology-with-electronic-circuit-board-texture-background-big-data-visualization-futuristic-computer-technology-concept-design-illustration-vector.jpg",
...
const users=[
    {name:'Ahmad Khaled',username:'Ahmad99',email:'circuitacademyproject@gmail.com',password:'123456789',phone:'1234567890',imageUrl:'',isSignedIn:false},
    {name:'Mohammad Omar',username:'OmarMoh',email:'teab2978@gmail.com',password:'00000000',phone:'95175368420',imageUrl:'',isSignedIn:false},
    {name:'Shams Doha',username:'SunnyDoha',email:'123doha@hotmail.com',password:'987654321',phone:'',imageUrl:'',isSignedIn:false},
    {name:'Test User',username:'TestUser0',email:'test@example.com',password:'123456789',phone:'',imageUrl:'',isSignedIn:false},
]

const posts = [
    {userEmail:'test@example.com',courseID:1,description:'First post in course 1!',imageUrl:''},
]
...
app.post('/user/signup',(req,res) => {
    ...
    if(rData){
        ...
        if(user){
            res.status(401).json({ message: `User with email ${rData.email} is already registered.`});
        }
        users.push(rData)
        console.log('User registered successfully - Data: ',rData);
        res.status(200).json({ message: 'Data and image received successfully', data: rData });
    }else{
        return res.status(400).json({ message: 'No valid data received' });
    }
});
