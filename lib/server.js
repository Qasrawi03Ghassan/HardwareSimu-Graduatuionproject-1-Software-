...
const courses=[
    ...
    {id:4,title:'Linear Circuits 1: DC Analysis',author:'Dr. Bonnie H. Ferri, Dr Mary Ann Weitnauer and Dr. Joyelle Harris',image:'https://static.vecteezy.com/system/resources/previews/004/937/500/non_2x/abstract-circuit-board-background-vector.jpg'}
]

const users=[
    {email:'circuitacademyproject@gmail.com',password:'123456789'},
    {email:'teab2978@gmail.com',password:'00000000'},
...
app.post('/user/signup',/*upload.single('profileImage'),*/(req,res) => {
    rData = req.body;
    //file = req.file;
