...
const serviceAccount = require("D:/College materials/2024_2025/2/Graduation project 1 - Software -/Hardware simulator platfrom/serverKeys/testfire-b75ce-firebase-adminsdk-fbsvc-08a0232ed0.json");
...
app.post('/courseExample/delete',async (req,res) => {
  rData = req.body;
  await deleteCourseFileTxt(rData);
  return res.status(200).json({ message: 'Data received successfully', data: rData });
});
